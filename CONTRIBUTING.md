...
```sh
$ go get -d github.com/Ch1f/otel
```

(This may print some warning about "build constraints exclude all Go
files", just ignore it.)

This will put the project in `${GOPATH}/src/github.com/Ch1f/otel`. You
...
(Note that `git clone` is *not* using the `github.com/Ch1f/otel` name -
